...
import type { ProtoGrpcType } from '~playfulbot/infrastructure/grpc/proto/types/playfulbot_v0';
import type { PlayfulBotClient } from '~playfulbot/infrastructure/grpc/proto/types/playfulbot/v0/PlayfulBot';
