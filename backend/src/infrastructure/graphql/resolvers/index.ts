...
import { createArenaGameResolver, createArenaResolver, getArenaResolver, arenaGamesResolver, deleteArenaResolver } from './arena';
...
const resolvers: gqlTypes.Resolvers<GraphqlContext> = {
  ...
  //   registerTournamentInvitationLink: registerTournamentInvitationLinkResolver,
    ...
    deleteArena: deleteArenaResolver,
