...
export type RegisterTournamentInvitationError =
  | AlreadyInATeamError
  | TournamentInvitationLinkNotFoundError;

export type RegisterTournamentInvitationResult =
  | RegisterTournamentInvitationSuccess
  | RegisterTournamentInvitationFailure;
...
export type GetAuthenticatedUserQuery = { __typename?: 'Query' } & {
  authenticatedUser?: Maybe<{ __typename?: 'User' } & Pick<User, 'id' | 'username'>>;
};

export type AuthenticatedUserTournamentsQueryVariables = Exact<{ [key: string]: never }>;

export type AuthenticatedUserTournamentsQuery = { __typename?: 'Query' } & {
  authenticatedUser?: Maybe<
    { __typename?: 'User' } & Pick<User, 'id' | 'username'> & {
        teams?: Maybe<
          ...
          >
        >;
        tournamentInvitations?: Maybe<
          Array<
            { __typename?: 'TournamentInvitation' } & Pick<TournamentInvitation, 'id'> & {
                tournament?: Maybe<
                  { __typename?: 'Tournament' } & Pick<
                    Tournament,
                    'id' | 'name' | 'lastRoundDate' | 'status'
...
export type CreateNewDebugGameMutation = { __typename?: 'Mutation' } & Pick<
  Mutation,
  'createNewDebugGame'
>;
...
export type CreateTournamentMutation = { __typename?: 'Mutation' } & {
  createTournament?: Maybe<{ __typename?: 'Tournament' } & Pick<Tournament, 'id' | 'name'>>;
};
...
export type DebugArenaSubscription = { __typename?: 'Subscription' } & {
  debugArena?: Maybe<{ __typename?: 'DebugArena' } & Pick<DebugArena, 'id' | 'game'>>;
};

export type GameCancelFragment = { __typename?: 'Game' } & Pick<Game, 'version' | 'canceled'>;

export type GameFragment = { __typename?: 'Game' } & Pick<
  Game,
  'id' | 'version' | 'canceled' | 'winners' | 'initialState' | 'patches'
> & {
    players?: Maybe<
      Array<Maybe<{ __typename?: 'Player' } & Pick<Player, 'id' | 'token' | 'connected'>>>
    >;
  };

export type GamePatchFragment = { __typename?: 'Game' } & Pick<
  Game,
  'version' | 'initialState' | 'patches' | 'winners'
>;

export type GamePlayersFragment = { __typename?: 'Game' } & {
  players?: Maybe<
    Array<Maybe<{ __typename?: 'Player' } & Pick<Player, 'id' | 'token' | 'connected'>>>
  >;
};
...
export type GameSubscription = { __typename?: 'Subscription' } & {
  game?: Maybe<
    | ({ __typename?: 'Game' } & Pick<
        Game,
        'id' | 'canceled' | 'version' | 'winners' | 'initialState' | 'patches'
      > & {
          players?: Maybe<
            Array<Maybe<{ __typename?: 'Player' } & Pick<Player, 'id' | 'token' | 'connected'>>>
          >;
        })
    | ({ __typename?: 'GamePatch' } & Pick<GamePatch, 'gameID' | 'version' | 'patch' | 'winners'>)
    | ({ __typename?: 'GameCanceled' } & Pick<GameCanceled, 'gameID' | 'version'>)
    | ({ __typename?: 'PlayerConnection' } & Pick<PlayerConnection, 'playerID' | 'connected'>)
  >;
};
...
export type GetTeamQuery = { __typename?: 'Query' } & {
  team?: Maybe<
    | ({ __typename?: 'Team' } & Pick<Team, 'id' | 'name'> & {
          members?: Maybe<Array<Maybe<{ __typename?: 'User' } & Pick<User, 'id' | 'username'>>>>;
        })
    | ({ __typename?: 'UserNotPartOfAnyTeam' } & Pick<UserNotPartOfAnyTeam, 'message'>)
  >;
};
...
export type JoinTeamMutation = { __typename?: 'Mutation' } & {
  joinTeam?: Maybe<
    | ({ __typename?: 'JoinTeamSuccess' } & {
        newTeam?: Maybe<{ __typename?: 'Team' } & Pick<Team, 'id'>>;
      })
    | ({ __typename?: 'JoinTeamFailure' } & {
        errors: Array<
          { __typename?: 'TeamNotFoundError' } & Pick<TeamNotFoundError, 'teamID' | 'message'>
        >;
      })
  >;
};
...
export type PlayMutation = { __typename?: 'Mutation' } & Pick<Mutation, 'play'>;

export type PlayerConnectedFragment = { __typename?: 'Player' } & Pick<Player, 'connected'>;

export type PlayerFragment = { __typename?: 'Player' } & Pick<Player, 'id' | 'token' | 'connected'>;

export type RegisterTournamentInvitationLinkMutationVariables = Exact<{
  tournamentInvitationLinkID: Scalars['ID'];
}>;

export type RegisterTournamentInvitationLinkMutation = { __typename?: 'Mutation' } & {
...
export type RoundSummaryQuery = { __typename?: 'Query' } & {
  round?: Maybe<
    { __typename?: 'Round' } & Pick<Round, 'id' | 'status' | 'startDate' | 'teamPoints'> & {
        teamGames?: Maybe<
          Array<
            Maybe<
              { __typename?: 'GameSummary' } & Pick<GameSummary, 'id'> & {
                  losers?: Maybe<Array<Maybe<{ __typename?: 'Team' } & Pick<Team, 'id' | 'name'>>>>;
                  winners?: Maybe<
...
export type TeamPlayerSubscription = { __typename?: 'Subscription' } & {
  teamPlayer?: Maybe<
    | ({ __typename?: 'Player' } & Pick<Player, 'id' | 'token' | 'connected'>)
    | ({ __typename?: 'PlayerConnection' } & Pick<PlayerConnection, 'playerID' | 'connected'>)
  >;
};
...
export type TournamentByInvitationLinkQuery = { __typename?: 'Query' } & {
  tournamentByInvitationLink?: Maybe<
    { __typename?: 'Tournament' } & Pick<Tournament, 'id' | 'name'>
  >;
};
...
export type TournamentRoundsQuery = { __typename?: 'Query' } & {
  tournament?: Maybe<
    { __typename?: 'Tournament' } & Pick<
      Tournament,
      | 'id'
...
export type TournamentTeamsQuery = { __typename?: 'Query' } & {
  tournament?: Maybe<
 ...
 * });
 */
export function useAuthenticatedUserTournamentsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    AuthenticatedUserTournamentsQuery,
    AuthenticatedUserTournamentsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    AuthenticatedUserTournamentsQuery,
    AuthenticatedUserTournamentsQueryVariables
  >(AuthenticatedUserTournamentsDocument, options);
}
export function useAuthenticatedUserTournamentsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    AuthenticatedUserTournamentsQuery,
    AuthenticatedUserTournamentsQueryVariables
  >
...
export type AuthenticatedUserTournamentsQueryHookResult = ReturnType<
  typeof useAuthenticatedUserTournamentsQuery
>;
export type AuthenticatedUserTournamentsLazyQueryHookResult = ReturnType<
  typeof useAuthenticatedUserTournamentsLazyQuery
>;
export type AuthenticatedUserTournamentsQueryResult = Apollo.QueryResult<
  AuthenticatedUserTournamentsQuery,
  AuthenticatedUserTournamentsQueryVariables
>;
...
`;
export type CreateNewDebugGameMutationFn = Apollo.MutationFunction<
  CreateNewDebugGameMutation,
  CreateNewDebugGameMutationVariables
>;
 ...
 * });
 */
export function useCreateNewDebugGameMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<CreateNewDebugGameMutation, CreateNewDebugGameMutationVariables>(
    CreateNewDebugGameDocument,
    options
  );
}
...
export type CreateNewDebugGameMutationOptions = Apollo.BaseMutationOptions<
  CreateNewDebugGameMutation,
  CreateNewDebugGameMutationVariables
>;
 ...
 * });
 */
export function useDebugArenaSubscription(
  baseOptions: Apollo.SubscriptionHookOptions<
    DebugArenaSubscription,
    DebugArenaSubscriptionVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSubscription<DebugArenaSubscription, DebugArenaSubscriptionVariables>(
    DebugArenaDocument,
    options
  );
}
...
export function useGameSubscription(
  baseOptions: Apollo.SubscriptionHookOptions<GameSubscription, GameSubscriptionVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useJoinTeamMutation(
  baseOptions?: Apollo.MutationHookOptions<JoinTeamMutation, JoinTeamMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function usePlayMutation(
  baseOptions?: Apollo.MutationHookOptions<PlayMutation, PlayMutationVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
`;
export type RegisterTournamentInvitationLinkMutationFn = Apollo.MutationFunction<
  RegisterTournamentInvitationLinkMutation,
  RegisterTournamentInvitationLinkMutationVariables
>;
 ...
 * });
 */
export function useRegisterTournamentInvitationLinkMutation(
  baseOptions?: Apollo.MutationHookOptions<
    RegisterTournamentInvitationLinkMutation,
    RegisterTournamentInvitationLinkMutationVariables
  >
  ...
  return Apollo.useMutation<
    RegisterTournamentInvitationLinkMutation,
    RegisterTournamentInvitationLinkMutationVariables
  >(RegisterTournamentInvitationLinkDocument, options);
}
export type RegisterTournamentInvitationLinkMutationHookResult = ReturnType<
  typeof useRegisterTournamentInvitationLinkMutation
>;
export type RegisterTournamentInvitationLinkMutationResult =
  Apollo.MutationResult<RegisterTournamentInvitationLinkMutation>;
export type RegisterTournamentInvitationLinkMutationOptions = Apollo.BaseMutationOptions<
  RegisterTournamentInvitationLinkMutation,
  RegisterTournamentInvitationLinkMutationVariables
>;
 ...
 * });
 */
export function useRoundSummaryQuery(
  baseOptions: Apollo.QueryHookOptions<RoundSummaryQuery, RoundSummaryQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<RoundSummaryQuery, RoundSummaryQueryVariables>(
    RoundSummaryDocument,
    options
  );
}
export function useRoundSummaryLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<RoundSummaryQuery, RoundSummaryQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<RoundSummaryQuery, RoundSummaryQueryVariables>(
    RoundSummaryDocument,
    options
  );
}
...
export type RoundSummaryQueryResult = Apollo.QueryResult<
  RoundSummaryQuery,
  RoundSummaryQueryVariables
>;
 ...
 * });
 */
export function useTeamPlayerSubscription(
  baseOptions: Apollo.SubscriptionHookOptions<
    TeamPlayerSubscription,
    TeamPlayerSubscriptionVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSubscription<TeamPlayerSubscription, TeamPlayerSubscriptionVariables>(
    TeamPlayerDocument,
    options
  );
}
...
export const TournamentByInvitationLinkDocument = gql`
  query tournamentByInvitationLink($tournamentInvitationLinkID: ID!) {
    tournamentByInvitationLink(tournamentInvitationLinkID: $tournamentInvitationLinkID) {
      id
      name
    }
  }
 ...
 * });
 */
export function useTournamentByInvitationLinkQuery(
  baseOptions: Apollo.QueryHookOptions<
    TournamentByInvitationLinkQuery,
    TournamentByInvitationLinkQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TournamentByInvitationLinkQuery, TournamentByInvitationLinkQueryVariables>(
    TournamentByInvitationLinkDocument,
    options
  );
}
export function useTournamentByInvitationLinkLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    TournamentByInvitationLinkQuery,
    TournamentByInvitationLinkQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    TournamentByInvitationLinkQuery,
    TournamentByInvitationLinkQueryVariables
  >(TournamentByInvitationLinkDocument, options);
}
export type TournamentByInvitationLinkQueryHookResult = ReturnType<
  typeof useTournamentByInvitationLinkQuery
>;
export type TournamentByInvitationLinkLazyQueryHookResult = ReturnType<
  typeof useTournamentByInvitationLinkLazyQuery
>;
export type TournamentByInvitationLinkQueryResult = Apollo.QueryResult<
  TournamentByInvitationLinkQuery,
  TournamentByInvitationLinkQueryVariables
>;
...
export function useTournamentQuery(
  baseOptions: Apollo.QueryHookOptions<TournamentQuery, TournamentQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useTournamentLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TournamentQuery, TournamentQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TournamentQuery, TournamentQueryVariables>(
    TournamentDocument,
    options
  );
}
 ...
 * });
 */
export function useTournamentRoundsQuery(
  baseOptions: Apollo.QueryHookOptions<TournamentRoundsQuery, TournamentRoundsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TournamentRoundsQuery, TournamentRoundsQueryVariables>(
    TournamentRoundsDocument,
    options
  );
}
export function useTournamentRoundsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TournamentRoundsQuery, TournamentRoundsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TournamentRoundsQuery, TournamentRoundsQueryVariables>(
    TournamentRoundsDocument,
    options
  );
}
...
export type TournamentRoundsQueryResult = Apollo.QueryResult<
  TournamentRoundsQuery,
  TournamentRoundsQueryVariables
>;
 ...
 * });
 */
export function useTournamentTeamsQuery(
  baseOptions: Apollo.QueryHookOptions<TournamentTeamsQuery, TournamentTeamsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<TournamentTeamsQuery, TournamentTeamsQueryVariables>(
    TournamentTeamsDocument,
    options
  );
}
export function useTournamentTeamsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<TournamentTeamsQuery, TournamentTeamsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<TournamentTeamsQuery, TournamentTeamsQueryVariables>(
    TournamentTeamsDocument,
    options
  );
}
...
export type TournamentTeamsQueryResult = Apollo.QueryResult<
  TournamentTeamsQuery,
  TournamentTeamsQueryVariables
>;
