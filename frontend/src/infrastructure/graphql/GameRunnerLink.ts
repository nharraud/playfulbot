...
export class GameRunnerLink extends ApolloLink {
  readonly defaultHttpLink: ApolloLink;
  readonly defaultWsLinks: ApolloLink;
  readonly wsLinks: Record<string, ApolloLink> = {};

  constructor(params: { defaultHttpLink: ApolloLink; defaultWsLinks: ApolloLink }) {
    super();
    this.defaultHttpLink = params.defaultHttpLink;
    this.defaultWsLinks = params.defaultWsLinks;
  }
