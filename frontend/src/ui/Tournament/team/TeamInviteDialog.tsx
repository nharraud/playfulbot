...
export function TeamInviteDialog(props: TeamInviteModalProps) {
  ...
  return (
    <Dialog
      ...
      aria-labelledby="team-invite-dialog-title"
      open={props.open}
    >
      <ClosableDialogTitle id="team-invite-dialog-title" onClose={props.handleClose}>
        Invite Players
      </ClosableDialogTitle>
      <DialogContent dividers>
        <p id="team-invite-modal-description" className={classes.description}>
          Send the following link to people you want to invite. Once registered they will be able to
