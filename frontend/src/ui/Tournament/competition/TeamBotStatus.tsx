  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <Grid item xs={12}>
          <Typography variant="h5" gutterBottom className={classes.title}>Team's bot</Typography>
        </Grid>
        <Grid item xs={5} className={classes.label}>
          <Typography variant="body1" gutterBottom>connected</Typography>
        </Grid>
        <Grid item xs={7} className={classes.value}>
          <Typography variant="body1" gutterBottom>{player?.connected ? 'yes' : 'no'}</Typography>
        </Grid>
        <Grid item xs={5} className={classes.label}>
          <Typography variant="body1" gutterBottom>token</Typography>
        </Grid>
        <Grid item xs={7} className={classes.value}>
